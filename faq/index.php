	...
	<div class="container">
		...
		<div class="content">
			<ul>
				...
				<li>Max file size is 100MB, for now at least. .</li>
				<li>Max file uploads at once is 50. The combined total must <= 100MB.</li>
				<li>The whole site uses full SSL/TLS HTTPS encryption with <a href="https://en.wikipedia.org/wiki/SPDY">SPDY</a>.</li>
				<li>No Child porn. Ever. No viruses or malware uploads.</li>
				<li>Just about all filetypes are allowed, ALL! (gif,jpg,cbr,rar,ass,srt,etc,etc) with the exception of .exe due to abuse usage.</li>
				...
				<li>mixtape.moe is hosted on a 1 Gigabit Solid State Drive server in Newark, NJ, US and Cloudflare's CDN helps out, I'm on a restrained budget.</li>
				<li>I want to deliver the best free service I can without ads so donations are very welcomed via the donate button on the front page and below via the Donate button.</li>
				<li>Malware scans are consistently done. Viruses will be quarantined if detected, we want to avoid my.mixtape.moe ending up on blacklists.</li>
				...
				<li>For removal of a file, contact us at <a href="mailto:abuse@mixtape.moe">abuse@mixtape.moe</a> for everything else, contact <a href="mailto:admin@mixtape.moe">admin@mixtape.moe</a></li>		 
